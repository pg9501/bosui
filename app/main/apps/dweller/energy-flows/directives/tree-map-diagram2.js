...
(function ()
{
  ...
  angular
    ...
    .directive('treeMapDiagramB',['$window','$mdDialog','d3Service',function($window,mdDialog,d3Service){
      return {
        restrict: 'EA',
        scope: {
          data: "@"
        ...
        link: function(scope, ele, attrs) {
         ...
         /*     var  dataArray=attrs.data;
           ...
           /*   $.getJSON(attrs.data, function(json) {
                console.log(json); // this will show the info it in firebug console
                main({title: ""}, {key: "World", values: json});
              });*/
          ...
          //    $('#chart').width(opts.width).height(opts.height);
             /* var width = opts.width - margin.left - margin.right,
              ...
              if (opts.title) {
                $("#" + containerID).prepend("<p class='title'>" + opts.title + "</p>");
              }
            ...
            (
              ...
              function (newValue, oldValue) {
                if (Math.abs(newValue.wpc - oldValue.wpc) >1 || Math.abs(newValue.hpc - oldValue.hpc)>1
                 ...
                 // console.log("width difference1 is : "+(newValue.wpc-oldValue.wpc));
                 // console.log("height difference1 is : "+(newValue.hpc-oldValue.hpc));

                /*  console.log("data are: "+attrs.data);
