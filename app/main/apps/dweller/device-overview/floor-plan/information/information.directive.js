(function ()
{
    ...
    angular
        ...
        .directive('floorPlanInformation', msThemeOptions);
    ...
    function msThemeOptions()
    {
        return {
            ...
            templateUrl: 'app/main/apps/dweller/device-overview/floor-plan/information/information.html',
            compile    : function (tElement)
            {
                tElement.addClass('floor-plan-information');

                return function postLink(scope, iElement)
                {
                    var bodyEl = angular.element('body'),
                        backdropEl = angular.element('<div class="floor-plan-information-backdrop"></div>');

                    // Panel open status
                 //   scope.panelOpen = scope.panelOpen || true;
